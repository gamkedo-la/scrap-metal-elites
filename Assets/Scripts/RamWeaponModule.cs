...
[CreateAssetMenu(fileName = "ram", menuName = "Modules/Ram Weapon")]
public class RamWeaponModule: Part {
    ...
    [Tooltip("ram part, assign ram joint for joint value")]
    public PartReference ram;
